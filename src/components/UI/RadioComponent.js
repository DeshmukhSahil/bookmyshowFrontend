...
const RadioComponent = ({ text, changeSelection, data }) => {
  ...
  //The handleChecked function is used to handle the radio button selection. It receives the selected value as an argument and calls the changeSelection function, which is also passed from the parent component, with the selected value.
